  ...
  return (
    <div className="h-full flex flex-col p-pad-2">
      ...
      <div className="mb-pad-2">
        <h1 className="text-3xl xl:text-5xl font-light text-my-cream leading-tight max-w-xl">
          Whatever I&apos;m into,{' '}
          <br />
          I&apos;m{' '}
      ...
      <div className="grid grid-cols-2 gap-3 max-w-xl">
        {activeSeries && (
          <Link
            ...
            className="group border border-my-espresso/40 p-4 flex flex-col gap-2 hover:border-my-orange/40 transition-colors"
          >
        ...
        {latestProject && (
          <Link
            ...
            className="group border border-my-espresso/40 p-4 flex flex-col gap-2 hover:border-my-stone/40 transition-colors"
          >
            <span className="text-my-stone text-xs uppercase tracking-widest">
              Latest Project
            </span>
            <span className="text-my-cream text-sm font-light leading-snug group-hover:text-my-orange transition-colors">
        ...
        {latestEssay && (
          <Link
            ...
            className="col-span-2 group border border-my-espresso/40 p-4 flex flex-col gap-2 hover:border-my-stone/40 transition-colors"
          >
            <span className="text-my-stone text-xs uppercase tracking-widest">
              Recent Writing
            </span>
      ...
      {/* Footer strip */}
      <div className="mt-auto border-t border-my-espresso/30 pt-3 flex justify-between">
        <span className="text-my-stone text-xs uppercase tracking-widest">Asheville, NC</span>
        <span className="text-my-stone text-xs uppercase tracking-widest">Est. 2025</span>
      </div>
    </div>
  );
}
