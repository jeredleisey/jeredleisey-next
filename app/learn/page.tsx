...
export default function LearnPage() {
  ...
  return (
    <div className="p-pad-2 max-w-lg">
      <h1 className="text-my-stone text-xs uppercase tracking-widest mb-pad-2">Learn</h1>

      {level101.length > 0 && (
        <section className="mb-8">
          <h2 className="text-my-stone text-xs uppercase tracking-widest border-b border-my-espresso/30 pb-2 mb-4">
            101 — Foundations
          </h2>
                ...
                >
                  ...
                  <span className="flex items-center gap-3 shrink-0">
                    ...
                    {series.metadata.status === 'coming-soon' && (
                      <span className="text-my-stone/50 text-xs uppercase tracking-widest">Soon</span>
                    )}
                  </span>
                </Link>
              </li>
