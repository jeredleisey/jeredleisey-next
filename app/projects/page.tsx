...
export default function ProjectsPage() {
  ...
  return (
    <div className="p-pad-2 max-w-lg">
      <h1 className="text-my-stone text-xs uppercase tracking-widest mb-pad-2">Projects</h1>

      <ul className="flex flex-col gap-0">
        {projects.map((project) => (
          <li key={project.slug} className="border-b border-my-espresso/30 last:border-0">
            <Link
